              ...
              notifications.map((n, i) => (
                ...
                >
                  ...
                  <div className="w-9 h-9 rounded-full flex-shrink-0 overflow-hidden bg-gray-200 border-2 border-white shadow-sm">
                    {n.likerProfileImage ? (
                      <img src={n.likerProfileImage.startsWith('http') ? n.likerProfileImage : `${BACKEND_URL}/images/uploads/${n.likerProfileImage}`} className="w-full h-full object-cover" alt="" />
                    ) : (
                  ...
                  {n.postImage && (
                    <div className="w-10 h-10 rounded-lg overflow-hidden flex-shrink-0 bg-gray-100">
                      <img src={n.postImage?.startsWith('http') ? n.postImage : `${BACKEND_URL}/images/uploads/${n.postImage}`} className="w-full h-full object-cover" alt="" />
                    </div>
                  )}
